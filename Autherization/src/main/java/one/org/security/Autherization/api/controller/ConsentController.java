...
public class ConsentController {
        ...
        public String consent(@RequestParam java.util.Map<String, String> parameters) {
                ...
                log.debug("ConsentController - Redirecting to Frontend Consent Page with params: {}", parameters);
                ...
                String state = parameters
                                .get(org.springframework.security.oauth2.core.endpoint.OAuth2ParameterNames.STATE);
                if (state != null) {
                        org.springframework.security.oauth2.server.authorization.OAuth2Authorization authorization = authorizationService
                                        .findByToken(
                                                        state,
                                                        new org.springframework.security.oauth2.server.authorization.OAuth2TokenType(
                        ...
                        if (authorization != null) {
                                ...
                                if (authorizationRequest != null) {
                                        log.debug("ConsentController - Recovered full Authorization Request from State");
                                        ...
                                        java.util.Map<String, Object> additionalParameters = authorizationRequest
