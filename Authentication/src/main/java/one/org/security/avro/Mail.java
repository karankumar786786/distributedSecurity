...
public class Mail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6414636908353211476L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Mail\",\"namespace\":\"one.org.security.avro\",\"fields\":[{\"name\":\"to\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"subject\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"body\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static BinaryMessageEncoder<Mail> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a Mail instance decoded from the given buffer
   ...
   */
  public Mail(java.lang.String to, java.lang.String subject, java.lang.String body) {
    this.to = to;
   ...
   */
  public static one.org.security.avro.Mail.Builder newBuilder() {
    return new one.org.security.avro.Mail.Builder();
  }
   ...
   * @return A new Mail RecordBuilder
   */
  public static one.org.security.avro.Mail.Builder newBuilder(one.org.security.avro.Mail.Builder other) {
    if (other == null) {
      return new one.org.security.avro.Mail.Builder();
    } else {
      return new one.org.security.avro.Mail.Builder(other);
    }
  }
   ...
   * @return A new Mail RecordBuilder
   */
  public static one.org.security.avro.Mail.Builder newBuilder(one.org.security.avro.Mail other) {
    if (other == null) {
      return new one.org.security.avro.Mail.Builder();
    } else {
      return new one.org.security.avro.Mail.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Mail>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(one.org.security.avro.Mail.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(one.org.security.avro.Mail other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder setTo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder setSubject(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder clearSubject() {
      subject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder setBody(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.org.security.avro.Mail.Builder clearBody() {
      body = null;
